...
- **Domain Top Pages with Page Classification**: View top 30 organic pages per domain with traffic and keyword counts. Features a comprehensive page classification system with rule-based and AI-powered classification. Classification columns include Page Type (12 categories), Page Intent (6 categories), SEO Relevance, SEO Action recommendations, and Classification Confidence. Click "Classify (Rules)" for rule-based classification or "Run AI for Uncertain" to use OpenAI for low-confidence pages. Click the "?" icon next to any classified value to view the detailed reasoning and rules that were applied. Supports filtering by all classification fields.
